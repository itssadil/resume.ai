...
class AddExperience extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        CustomTextField(controller: jobTitleController, labelText: "Job Title"),
        CustomTextField(
            controller: companyNameController, labelText: "Company Name"),
        CustomTextField(
            controller: locationController, labelText: "Location(Optional)"),
        Padding(
